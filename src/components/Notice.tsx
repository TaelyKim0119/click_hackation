    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {notices.map((item) => (
          <div
            key={item.title}
            className="glass-panel rounded-2xl p-8 flex gap-5 border-red-500/20 hover:border-red-500/40 transition-all"
          >
            ...
            <div className="flex flex-col gap-2">
              <h4 className="font-black text-lg text-shadow-sharp">{item.title}</h4>
