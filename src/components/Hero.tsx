        ...
        <div className="relative z-10 flex flex-col gap-6 max-w-3xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4">
            <button
              ...
              className="px-10 py-4 bg-primary text-white text-lg font-black rounded-xl hover:scale-105 transition-transform shadow-lg shadow-primary/25 text-shadow-sharp hover:bg-violet-600 shadow-violet-500/30"
            >
              지금 신청하기
            </button>
          </div>
